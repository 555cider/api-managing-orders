...
class ReviewRestControllerTest {
	...
	void reviewFailureTest1() throws Exception {
		ResultActions result =
				mockMvc.perform(post("/api/orders/5/review").contentType(MediaType.APPLICATION_JSON)
	...
	void reviewFailureTest2() throws Exception {
		ResultActions result = mockMvc.perform(post("/api/orders/5/review")
	...
	void reviewFailureTest3() throws Exception {
		ResultActions result = mockMvc.perform(post("/api/orders/1/review")
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content("{\"content\":\"this is review content!\"}"));
		result.andDo(print()).andExpect(status().is4xxClientError())
				.andExpect(handler().handlerType(ReviewRestController.class))
	...
	void reviewFailureTest4() throws Exception {
		ResultActions result = mockMvc.perform(post("/api/orders/4/review")
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content("{\"content\":\"this is review content!\"}"));
		result.andDo(print()).andExpect(status().is4xxClientError())
				.andExpect(handler().handlerType(ReviewRestController.class))
