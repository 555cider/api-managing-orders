...
class OrderRestControllerTest {
	...
	void findByIdSuccessTest() throws Exception {
		for (int i = 1; i < 8; i++) {
			ResultActions result = mockMvc.perform(get("/api/orders/" + i)
					.accept(MediaType.APPLICATION_JSON));
			result.andDo(print())
					.andExpect(status().isOk())
					.andExpect(handler().handlerType(OrderRestController.class))
	...
	void acceptSuccessTest() throws Exception {
		ResultActions result = mockMvc.perform(patch("/api/orders/1/accept")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
		...
		result = mockMvc.perform(get("/api/orders/1")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
	...
	void acceptFailureTest() throws Exception {
		for (int i = 2; i < 7; i++) {
			ResultActions result = mockMvc.perform(patch("/api/orders/" + i + "/accept")
					.accept(MediaType.APPLICATION_JSON));
			result.andDo(print())
					.andExpect(status().isOk())
					.andExpect(handler().handlerType(OrderRestController.class))
			...
			result = mockMvc.perform(get("/api/orders/" + i)
					.accept(MediaType.APPLICATION_JSON));
			result.andDo(print())
					.andExpect(status().isOk())
					.andExpect(handler().handlerType(OrderRestController.class))
	...
	void shippingSuccessTest() throws Exception {
		ResultActions result = mockMvc.perform(patch("/api/orders/2/shipping")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
				...
				.andExpect(jsonPath("$.success", is(true)))
				.andExpect(jsonPath("$.response", is(true)));
		result = mockMvc.perform(get("/api/orders/2")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
	...
	void shippingFailureTest() throws Exception {
		for (int i = 3; i < 8; i++) {
			ResultActions result = mockMvc.perform(patch("/api/orders/" + i + "/shipping")
					.accept(MediaType.APPLICATION_JSON));
			result.andDo(print())
					.andExpect(status().isOk())
					.andExpect(handler().handlerType(OrderRestController.class))
	...
	void completeSuccessTest() throws Exception {
		ResultActions result = mockMvc.perform(patch("/api/orders/3/complete")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
				...
				.andExpect(jsonPath("$.success", is(true)))
				.andExpect(jsonPath("$.response", is(true)));
		result = mockMvc.perform(get("/api/orders/3")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
	...
	void completeFailureTest() throws Exception {
		for (int i = 4; i < 8; i++) {
			ResultActions result = mockMvc.perform(patch("/api/orders/" + i + "/complete")
					.accept(MediaType.APPLICATION_JSON));
			result.andDo(print())
					.andExpect(status().isOk())
					.andExpect(handler().handlerType(OrderRestController.class))
	...
	void rejectSuccessTest() throws Exception {
		ResultActions result = mockMvc.perform(patch("/api/orders/7/reject")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON)
				.content("this is reject message!"));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
				...
				.andExpect(jsonPath("$.success", is(true)))
				.andExpect(jsonPath("$.response", is(true)));
		result = mockMvc.perform(get("/api/orders/7")
				.accept(MediaType.APPLICATION_JSON));
		result.andDo(print())
				.andExpect(status().isOk())
				.andExpect(handler().handlerType(OrderRestController.class))
	...
	void rejectFailureTest2() throws Exception {
		for (int i = 2; i < 7; i++) {
			ResultActions result = mockMvc.perform(patch("/api/orders/" + i + "/reject")
					.contentType(MediaType.APPLICATION_JSON)
					.accept(MediaType.APPLICATION_JSON)
